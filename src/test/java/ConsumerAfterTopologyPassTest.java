...
public class ConsumerAfterTopologyPassTest extends ActiveMQTestBase implements MessageListener{
   ...
   public void testRedistributor() throws Exception {
      ...
      createQueue(url1);
      System.out.println(">>>> QUEUE STAT AFTER CREATING QUEUE ON BROKER1 >>>");
      stats(url1);
